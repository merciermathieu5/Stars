/* Harnais de validation — Stars de Dallas (jsdom) */
const fs = require('fs');
...
const ATTENDU = {
  equipe: 'DALLAS',
  taille: 24,
  echantillon: {nom: 'Julian Lutz', salaire: 800000, ct: 1, ov: 77},
  masseSousContrat: 27100000,
  nbSousContrat: 6,
  dateSecours: '8 juillet 2026',
  nbEchus: 18,
  nbBackups: 0,
  masseTotale: 94100000
};
...
(async () => {
  ...
  W.localStorage.removeItem('dal_resignatures_v1');
  W.localStorage.removeItem('dal_transac_v1');
